// Source of truth: /public/documents/portfolio-details.txt
...
export const stats = [
  ...
  { label: 'Systems Delivered', value: '15+' },
...
export const skillCategories = [
  {
    ...
    icon: '⚡',
    skills: [
      'Expert-level AppSheet Development',
      'Custom SVG for UI/UX',
      'LongText HTML & Image Columns',
      'Dynamic KPI Widgets',
      'Progress Trackers',
...
export const portfolio = [
  {
    ...
    description: 'Custom AppSheet application for end-to-end project tracking with task assignment, progress monitoring, deadline management, and SVG dashboard visualizations.',
    demo: 'https://www.appsheet.com/start/c334d061-def1-4787-bdab-5d088b5d28fd',
    tags: ['AppSheet', 'SVG UI', 'Dashboard'],
  },
  {
    name: 'CRM & Lead Management System',
    description: 'Advanced CRM solution for lead tracking and pipeline management, featuring lead scoring, automated Make.com follow-up workflows, conversion tracking, and analytics dashboards.',
    demo: 'https://www.appsheet.com/start/c1b48401-ad92-478b-98de-5adb9daa7317',
    tags: ['CRM', 'Make.com', 'Analytics'],
  },
  {
    name: 'Order Management & POS System',
...
export const techStack = [
  { category: 'Platform', items: ['AppSheet (Expert)', 'Google Workspace', 'Google Sites'] },
  { category: 'Automation', items: ['Make.com', 'N8N', 'Google Apps Script', 'AI Agent Development'] },
  { category: 'Analytics', items: ['Looker Studio', 'Google Sheets (Advanced)', 'Data Modeling', 'KPI Frameworks'] },
  { category: 'UI/UX', items: ['AppSheet SVG Design', 'CONCATENATE Formula SVGs', 'LongText HTML', 'Data URI Encoding'] },
  { category: 'Integration', items: ['REST APIs', 'Webhooks', 'Supabase', 'Aircall', 'Gmail', 'Google Calendar'] },
  { category: 'Languages', items: ['HTML', 'CSS', 'JavaScript (Intermediate)', 'Google Apps Script'] },
]
