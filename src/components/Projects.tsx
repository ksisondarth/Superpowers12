...
const PROJECTS = [
  {
    ...
    date: '2024 - Present',
    description: 'End-to-end project tracking with task assignment, milestone monitoring, deadline management, and custom SVG dashboard visualizations. Built for a UK-based furniture client.',
    tags: ['AppSheet', 'SVG UI', 'Looker Studio', 'Make.com'],
  ...
  },
  {
    ...
    category: 'Inventory',
    date: '2024',
    description: 'Complete point-of-sale and order management system with item selection, quantity management, automatic total calculation, and streamlined order processing workflows.',
    tags: ['AppSheet', 'Google Sheets', 'Automation', 'SVG UI'],
    demo: 'https://www.appsheet.com/start/d62f57ca-62b0-417b-a39d-e794f7e474b7',
  },
  {
    id: 4,
    title: 'University Student Affairs System',
    category: 'AppSheet',
    date: '2021 - Present',
    description: 'Comprehensive multi-department management system for Ateneo de Manila University covering student-facing workflows, automated email notifications, and Looker Studio reporting.',
    tags: ['AppSheet', 'Google Apps Script', 'Looker Studio', 'SVG UI'],
    demo: '#',
  },
  {
    id: 5,
    ...
    category: 'Automation',
    date: '2024 - 2025',
    description: 'Team-integrated ticketing system with webhook-driven notifications, priority escalation workflows, SLA tracking, and real-time status dashboards for operational oversight.',
  ...
  {
    id: 7,
    title: 'HR Analytics & Recruitment Dashboard',
    category: 'Dashboards',
    date: '2017 - 2019',
    ...
    tags: ['Looker Studio', 'Google Sheets', 'Data Modeling', 'KPI Frameworks'],
    demo: '#',
  },
  {
    id: 8,
    title: 'Logistics Delivery Planning System',
    category: 'Inventory',
    date: '2024',
    ...
    tags: ['AppSheet', 'Looker Studio', 'Google Sheets', 'Automation'],
    demo: '#',
  },
  {
    id: 9,
    title: 'Business Website & Lead Gen',
    category: 'CRM',
    date: '2023 - 2024',
...
const CATEGORY_COLORS: Record<string, string> = {
  AppSheet: 'text-teal-500 bg-teal-50 dark:bg-teal-900/20 border-teal-200 dark:border-teal-800',
  Automation: 'text-purple-500 bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800',
  CRM: 'text-blue-500 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800',
  Inventory: 'text-orange-500 bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800',
  'Project Management': 'text-green-500 bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800',
  Dashboards: 'text-pink-500 bg-pink-50 dark:bg-pink-900/20 border-pink-200 dark:border-pink-800',
}
    ...
    <div className="py-20 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium border transition-all ${
                active === f
                  ...
                  : 'border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-teal-400 hover:text-teal-400'
              }`}
            >
              {f}
            </button>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
          {visible.map(p => (
            <div key={p.id} className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0d1117] p-5 flex flex-col hover:border-teal-400/40 transition-all">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-base">{p.title}</h3>
        ...
        {!showAll && remaining > 0 && (
          <div className="text-center">
            <button
              ...
              className="px-6 py-3 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 text-sm font-medium hover:border-teal-400 hover:text-teal-400 transition-all"
            >
