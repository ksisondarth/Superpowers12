      ...
      <div className="max-w-7xl mx-auto px-[15px]">
        <div className="grid lg:grid-cols-2 gap-12 items-start pb-14">
          ...
          <div>
            ...
            <p className="text-xl text-gray-500 dark:text-gray-400 mb-5">{siteSettings.title}</p>
              ...
              {HERO_SKILLS.map(s => (
                <span
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm border ${
                    BOLD_SKILLS.includes(s) ? 'font-semibold' : 'border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400'
                  }`}
                  style={BOLD_SKILLS.includes(s) ? { borderColor: 'var(--accent-border)', backgroundColor: 'var(--accent-bg)', color: 'var(--accent)' } : {}}
                >
                  {s}
                </span>
              ))}
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              <a href={siteSettings.cvPdf} download className="btn-outline flex items-center gap-2">
